...
const Home = () => {
  ...
  return (
    <Box sx={{ maxWidth: 1280, marginX: 'auto' }}>
      ...
      <Box sx={{ height: '100%', pt: 14 }} id='Modernste Technologie'>
      ...
      <Box sx={{ height: '100%', pt: 14 }} id='Engagierte Montage'>
      ...
      <Box sx={{ height: '100%', pt: 14 }} id='Qualifiziertes Schweißen'>
        <Typography variant='body1' sx={{ mt: 14 }}>
      ...
      <Box sx={{ height: '100%', pt: 14 }} id='Innovative Ingenieurarbeit'>
        <Typography variant='body1' sx={{ mt: 14 }}>
